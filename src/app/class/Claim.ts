export class Claim{
    ...
    constructor( id : number,claimedDate : Date , documentProof :string ,causeOfClaim :string , claimableAmount: number,  claimRequestAmount: number, claimReviewed : boolean){
        this.id =id;
