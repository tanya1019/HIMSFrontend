...
@Component({
  selector: 'app-display-all-reviewed-claim',
  templateUrl: './display-all-reviewed-claim.component.html',
  styleUrls: ['./display-all-reviewed-claim.component.css']
})
export class DisplayAllReviewedClaimComponent implements OnInit {
  ...
  updateClaimById(claimId?:number) {
    ...
    .subscribe({
      next:(data)=>{
        // console.log(data);
        alert("Claim Reviewed Status : !! True !!");
        this.loadPoliciesToComponent();
      },
